...
//
  ...
  #define LASER_CUTTER_UNIT_IS(V)    (_CUTTER_POWER(LASER_CUTTER_POWER_UNIT)    == _CUTTER_POWER(V))
  #define SPINDLE_CUTTER_UNIT_IS(V)    (_CUTTER_POWER(SPINDLE_CUTTER_POWER_UNIT)    == _CUTTER_POWER(V))
#endif

// Add features that need hardware PWM here
#if ANY(FAST_PWM_FAN, SPINDLE_PWM, LASER_PWM)
  #define NEEDS_HARDWARE_PWM 1
#endif

#define NEEDS_PWM ANY(FAST_PWM_FAN, LASER_PWM, SPINDLE_PWM) // Add PWM mandating features here
